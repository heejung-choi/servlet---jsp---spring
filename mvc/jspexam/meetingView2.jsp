...
%>
			...
			<!-- displayUpdateForm는 아규먼트로 해당글의 아이디를 전달하게 하고 있다. -->
<%
		}
%>
	</table>
...
<script>
function displayDiv(type) { /* div 태그를 보여주고 안보여주고 하는것에 연관이 있다. */
	if(type == 1) {
...
function displayUpdateForm(cv) {
	...
	var ary = str.split(/\D+/g)/* 숫자가 아닌것은 쪼갰다. */
...
<div id="search" style="display:none"><!-- 버튼을 눌렀을때 나타난다. -->
